...
\bottomrule
\end{tabular}
\caption{HierarCaps test set (1000 four-level chains): radial ordering under the paper's projection (chance for strict monotonicity $=1/24\approx4.2\%$; shuffle controls $\approx 0$), sibling triplet agreement (cosine; chance $0.5$), and leaf $\hat\delta$ with spectrum-null excess.}
\label{tab:a8}
\end{table}
