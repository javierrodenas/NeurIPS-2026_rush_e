...
**A2.** Yes — new matched-$n,d$ controls on the ImageNet centroids (three representative rows below; all 12 models were measured, and the full table will be added to the revision):
