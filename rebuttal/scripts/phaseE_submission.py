...
,
         ...
         ('clusters oriented toward their hubs in a few; no hierarchy among the hubs where the test can see one;',
          'clusters oriented toward their superclass centers in a few; no hierarchy among those centers where the test can see one;'),
...
PANELCAP = {
 ...
 ("tab_q04_depth", "a"): r"\textbf{Clusters are oriented toward their hubs in 4 of 12 backbones under the star with Gaussian hubs.} Per backbone: the depth statistic and its $z$ on CIFAR-100 and on ImageNet, the WordNet cut at 3 sizes, and the balanced grouping.",
