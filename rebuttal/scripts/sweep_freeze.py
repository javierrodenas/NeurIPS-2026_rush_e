...
def final_checks():
    ...
    THESIS = "Read correctly, foundation models organize classes into clustered structure that is moderately shared and does not converge to one common tree; no hierarchy above the superclasses is found where the test has power; and their raw tree-likeness is not evidence for hyperbolic geometry."   # brief of 2026-09-21 (priorities 1b and 2 integrated)
