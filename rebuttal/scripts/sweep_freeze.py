...
def final_checks():
    ...
    LEADS53 = ["The hierarchy test certifies that clusters are oriented toward their hubs in 4 of 12 backbones: ViT-S, ViT-B, ViT-L and DINOv2-L.", "What it certifies is alignment.", "What the test can see.", "A trained hierarchy survives, and the decoupled test leans toward firing.", "No hub hierarchy is found where the test has power.", "The certified set depends on the frame.", "Leaf labels can produce the alignment but do not guarantee it.", "MERU's objective does not create hub structure."]   # cleanup of 2026-09-22; MERU lead-in since the twelfth review
