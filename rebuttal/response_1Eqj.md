...
We hope these answers clarify the points our presentation left unclear — particularly the absolute-vs-normalized $\delta$ distinction, which our text failed to make explicit and which we believe underlies several of the concerns. We are happy to clarify anything else during the discussion phase.
