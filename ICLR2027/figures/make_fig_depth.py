...
ax.text(0.52, 0.30, f"false alarms at $s{{=}}0$:\n{pr.loc[0.0]:.2f} real, {pt.loc[0.0]:.2f} shrunk", fontsize=7, color="k", ha="left", va="center", linespacing=1.15)
...
ax.legend(frameon=False, fontsize=7, loc="center right", bbox_to_anchor=(1.0, 0.62), handlelength=1.6, labelspacing=0.3)
