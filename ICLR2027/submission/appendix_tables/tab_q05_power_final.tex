...
\toprule
cloud & seed & $d$ & excess & $r$ & depth $z$ & $z$ rotated & cert. \\
\midrule
...
\par\vspace{2pt}
\endgroup
\caption{\textbf{A deep hierarchy at the real noise level is detected, and a flat control is not.} Synthetic clouds with ViT-L's spectrum and ratio: the depth $z$ intact and with clusters rotated, for the hierarchy and for the flat control.
}
