...
\par\vspace{2pt}
\endgroup
\caption{\textbf{How clusters are oriented relative to their hubs is not random in 4 of 12 backbones under the star with Gaussian hubs.} Per backbone: depth and $z$ on CIFAR-100 and ImageNet, 3 WordNet cuts and the balanced grouping.
}
\label{tab:q4-depth}
\end{table}
\begin{table}[H]
