...
- line 161: Lemma 1 (range bound)
- line 163: Corollary 1 (dimension confound)
- line 166: Remark: spectrum and statistic confounds
- line 169: calibration on reference geometries (Table 3 of the brief)

## 3.3 Spectrum-matched null, excess and genuineness

- line 174: Definition 3 (Haar null)
- line 179: why Haar and not Gaussian coefficients
- line 184: Definition 4 (excess), Eq. 3
- line 190: rank and left-tail p, Eq. 4, K = 200
- line 195: Definition 5 (genuine), Eq. 5
- line 199: clustered structure vs tree-like; Figure 2 cited

## 3.4 Depth test

- line 207: Definition 6 (hub null and excess B)
- line 229: Definition 7 (matched star)
- line 239: Eq. 6, certification at z ≤ −2
- line 239: the star caveat
- line 243: validity measured in §5.3

## 3.5 Comparing trees across models

- line 245: dendrograms, three measures, degeneracy criterion, calibrated local agreement

## 3.6 Projection and tasks

- line 259: the map, the two tasks, three readouts

## 4 Experimental Setup

- line 264: models and the compact panel
- line 273: datasets, cells, two levels
- line 280: extraction
- line 286: replicates, seeds, budgets, BH, frames, star seeds
...
- line 306: 70/72 negative, 49/72 genuine (Table 1, Figure 3)
- line 311: 18/24 on ImageNet and CIFAR-100; 42–47 under joint sensitivity
- line 316: every family; ViT-T on DTD only; flat datasets; class-count control; two ResNets
...
- line 456: naive map isolates DINOv2 (0.03 vs 0.64): chaining artifact; DINO-B not in the island (Figure 5)
- line 462: selected configuration 0.38 vs 0.48; other admissible 0.13–0.17 vs 0.50–0.55
- line 470: cophenetic 0.48 vs 0.78; triplets 0.77 vs 0.76 under cosine-average only
- line 99: angular tree: 0.91/0.85 cosine vs 0.71/0.63 Euclidean for DINOv2-L/G
- line 479: cosine census agrees in 65/72
