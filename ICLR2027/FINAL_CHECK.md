...
- PDF pages: 37. Main text (through the Conclusion and Limitations section) ends on page 10; the Reproducibility, Ethics and AI Use statements start on page 10 (ICLR line 492); the references start on page 10 (line 510).
...
Non-verbatim prose of S3–S7: 134 sentences, mean 19.9 words (rule: mean ≤ 22, none > 35).
...
| Results | What the test can see. | 4 of 5, 0.83 to 1.00, 0.01 to 0.60, 1.5 to 3.0, 1.3 to 3.9, 10 of 10, 0 of 10, 0 of 5, 8 of 50, -4.19 to -4.82, 0 of 50 |
