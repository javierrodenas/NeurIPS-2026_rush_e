...
- PDF pages: 31. Main text (through the Conclusion and Limitations section) ends on page 9; the Reproducibility, Ethics and AI Use statements start on page 9 (ICLR line 482); the references start on page 10 (line 500).
...
Non-verbatim prose of S3–S7: 148 sentences, mean 17.7 words (rule: mean ≤ 22).
