...
ORDER = list(NAME)
FINAL_ONLY = bool(os.environ.get("FINAL_ONLY"))          # final version: CENSUS_SRC=expR75_census_centered_haar.csv FINAL_ONLY=1 writes tab_census_final.tex only (the record is the centered Haar null since 2026-09-20)
src = os.environ.get("CENSUS_SRC", "expR52_census_haar_p999_200.csv")   # v1 census of record (Phase B): Haar null x p99.9 statistic, BH
...
print("wrote", "tab_census_final.tex" if FINAL_ONLY else "tab_census.tex", "from", src)
