...
\end{tabular}
\par\vspace{2pt}
\caption{\textbf{Training in hyperbolic space creates no hub structure.} MERU and its Euclidean twin at 3 sizes: the census excess, the depth $z$ and the radii of the embeddings in units of the curvature scale. $^{\circ}$: not genuine at the corrected threshold.
}
