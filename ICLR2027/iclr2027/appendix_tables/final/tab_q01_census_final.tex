...
\noindent\textbf{(a) The census per cell.}\par\vspace{1.5pt}
...
\end{tabular}
\par\vspace{2pt}
\caption{\textbf{Structure beyond the second moments is the rule at the class level under every construction of the null.} Panels: the reading used in the paper per cell, the verdict under five constructions of null and statistic, the same census on cosine geometry, and the backbones read only on ImageNet.
}
\label{tab:q1-census}
\end{table}
...
\setlength{\tabcolsep}{1.4pt}
\begingroup
\noindent\textbf{(c) The same census on cosine geometry (L2-normalized centroids, geodesic distances, Haar null on the normalized cloud).}\par\vspace{1.5pt}
