...
\end{tabular}
\par\vspace{2pt}
\caption{\textbf{Structure beyond the second moments is the rule at the class level.} Per cell: the reading, its excess over the matched null, the excess as a fraction of the null, the rank among the replicates and the left-tail $p$.
}
\label{tab:q1-census}
\end{table}
\begin{table}[H]
...
\par\vspace{2pt}
\endgroup
\caption{\textbf{The backbones outside the ViT panel read like it.} The 2 self-supervised ResNets on the ImageNet centroid store: dimension, reading, excess and rank against the spectrum null.
}
\label{tab:q1-census-d}
\end{table}
