...
\end{tabular}
\par\vspace{2pt}
\caption{\textbf{At the sample level, where the premise is read, the reading sits within null noise in most cells.} Per cell: the statistic, the excess, the excess as a fraction of the null, the rank and the left-tail $p$.
}
\label{tab:q3-sample}
\end{table}
