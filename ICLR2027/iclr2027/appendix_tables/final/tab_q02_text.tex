...
\begingroup
\noindent\textbf{(a) The census on the 1000 ImageNet class prompts.}\par\vspace{1.5pt}
...
\par\vspace{2pt}
\endgroup
\caption{\textbf{In text, structure beyond the second moments depends on the recipe and the scale.} Columns: the statistic, its excess over the matched null, the rank among the replicates and the left-tail $p$ per model, and the same prompts under changes of batch size and precision.
}
\label{tab:q2-text}
\end{table}
