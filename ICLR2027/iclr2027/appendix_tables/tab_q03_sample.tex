% prov: expR62_samplelevel_record.csv
\begin{table}[H]
\centering
\scriptsize
...
\toprule
& \multicolumn{6}{c|}{CIFAR-100 (10 images/class, $n{=}1000$)} & \multicolumn{6}{c}{DTD (22 images/class, $n{=}1034$)} \\
model & supremum $\hat\delta$ & $\hat\delta_{99.9}$ & excess & exc./null & $r$/200 & $p$ & supremum $\hat\delta$ & $\hat\delta_{99.9}$ & excess & exc./null & $r$/200 & $p$ \\
\midrule
