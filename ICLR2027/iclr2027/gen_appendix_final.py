...
def main_khrulkov():
    ...
    hdr = (r"dataset & their $\delta_{\text{rel}}$ & ours, their estimator & excess & $r$/200, largest $p$ & excess (sup.) & $r$/200, $p$ range (sup.) \\" if S85 is not None else r"dataset & their $\delta_{\text{rel}}$ & ours, their estimator & excess & $r$/200, largest $p$ \\")
